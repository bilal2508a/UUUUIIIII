...
<div class="auth-wrapper">
    ...
    <div class="auth-panel-image">
        ...
        <div class="auth-panel-image-content">
            ...
            <h2 style="font-size:2.25rem;font-weight:800;color:#fff;line-height:1.2;margin:0 0 0.75rem;letter-spacing:-0.02em;">Find your next<br>home with us.</h2>
            <p style="font-size:1.05rem;color:rgba(255,255,255,0.85);margin:0;max-width:420px;line-height:1.6;">Join thousands of tenants and owners on Pakistan's premier rental platform. It's free to get started.</p>
            <div style="display:flex;flex-direction:column;gap:0.875rem;margin-top:2rem;">
                <div style="display:flex;align-items:center;gap:0.75rem;color:rgba(255,255,255,0.9);font-size:0.95rem;">
                    <div style="width:28px;height:28px;border-radius:50%;background:rgba(255,255,255,0.2);display:flex;align-items:center;justify-content:center;flex-shrink:0;"><i class="bi bi-check" style="font-weight:bold;"></i></div>
    ...
    <div class="auth-panel-form">
        <div style="width:100%;max-width:460px;animation:fadeInUp 0.5s ease;">
            ...
            <p style="color:var(--slate-500);margin:0 0 2rem;">Join Mehmaan Hub to find or list properties</p>
