...
foreach ($ownerBookings as $b) {
    ...
    if ($b['status'] === 'confirmed' && $b['payment_status'] === 'paid') {
        $stats['earnings'] += (float)$b['total_amount'];
    }
}
...
<section style="padding:2.5rem 0;">
    <div class="container-app">
            ...
            <div class="col-6 col-lg-3">
                <div class="card" style="border:none;border-radius:16px;box-shadow:0 4px 20px rgba(0,0,0,0.06);padding:1.5rem;">
                    <div style="display:flex;align-items:center;gap:1rem;">
                        ...
                        <div>
                            <div style="font-size:1.75rem;font-weight:800;color:#0f172a;line-height:1;"><?php echo $stats['pending']; ?></div>
                            <small style="color:#64748b;">Pending Requests</small>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-6 col-lg-3">
                <div class="card" style="border:none;border-radius:16px;box-shadow:0 4px 20px rgba(0,0,0,0.06);padding:1.5rem;">
                    <div style="display:flex;align-items:center;gap:1rem;">
                        ...
                        <div>
                            <div style="font-size:1.5rem;font-weight:800;color:#0f172a;line-height:1;"><?php echo format_price($stats['earnings']); ?></div>
        ...
        <div style="display:flex;gap:0.5rem;margin-bottom:1.5rem;border-bottom:2px solid #e2e8f0;flex-wrap:wrap;">
            <button class="tab-btn active" data-tab="bookings" onclick="switchTab('bookings')"><i class="bi bi-calendar-check"></i> Booking Requests</button>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($b['status'] === 'pending'): ?>
                                            <a href="<?php echo url('/api/booking-action.php?id=' . (int)$b['id'] . '&action=approve'); ?>" class="btn btn-success btn-sm" style="border-radius:8px;"><i class="bi bi-check-lg"></i> Approve</a>
                                            <a href="<?php echo url('/api/booking-action.php?id=' . (int)$b['id'] . '&action=reject'); ?>" class="btn btn-error btn-sm" style="border-radius:8px;"><i class="bi bi-x-lg"></i> Reject</a>
                                        <?php else: ?>
                ...
                <div class="col-md-6">
                    <div class="card" style="border:none;border-radius:16px;box-shadow:0 4px 20px rgba(0,0,0,0.06);padding:2rem;">
                        ...
                        <div style="display:flex;justify-content:space-between;padding:0.75rem 0;border-bottom:1px solid #e2e8f0;">
                            <span style="color:#64748b;">Total Earnings (Paid)</span>
                            <strong style="color:#0f172a;"><?php echo format_price($stats['earnings']); ?></strong>
                        </div>
                        <div style="display:flex;justify-content:space-between;padding:0.75rem 0;border-bottom:1px solid #e2e8f0;">
                        ...
                        <div style="display:flex;justify-content:space-between;padding:0.75rem 0;">
                            ...
                            <strong style="color:#0f172a;"><?php echo $stats['pending']; ?></strong>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
