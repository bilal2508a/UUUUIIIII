        ...
        <div class="col-lg-7">
                ...
                <form method="POST" action="<?php echo url('/booking.php?property_id=' . $propertyId); ?>">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="d-flex gap-2">
                            <button type="button" class="btn btn-primary booking-mode-btn active" data-mode="month" onclick="selectBookingMode('month')">
                                <i class="bi bi-calendar-month"></i> Monthly
                            </button>
                            <button type="button" class="btn btn-ghost booking-mode-btn" data-mode="day" onclick="selectBookingMode('day')">
            ...
            <div class="card-premium" style="padding:1.75rem;">
                ...
                <div class="row g-2">
                    ...
                    <div class="col-md-6">
                        <label class="checklist-item d-flex align-items-center gap-2 p-2" style="border-radius:var(--radius-sm);border:1px solid var(--slate-200);">
